...
export default function FinanceCard(props: Props) {
  ...
  return (
    <div className="container  sm:max-w-xs bg-white w-full flex flex-col border border-gray-200 items-start py-4 justify-center space-y-2 shadow-sm rounded-lg px-4">

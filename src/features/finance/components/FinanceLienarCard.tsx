...
export default function FinanceLinearCard({ data }: Props) {
  return (
    <div className="container bg-white w-full flex flex-col border border-gray-200 items-start py-4 justify-center space-y-2 shadow-sm rounded-lg px-4 h-full">
